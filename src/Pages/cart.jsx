        ...
        <>
            {load.cart.length > 0 ? (
                        ...
                        <div className="cart-container row ">
                                ...
                                <form className="mt-4">
                                    <div className="d-flex justify-content-between">
                                        <div className="d-flex">
                                            <input type="email" className="form-control" id="inputEmail3" placeholder="کد کارت هدیه" />
                                            <button type="button" className="btn btn-success">اعمال کد تخفیف</button>
                                        </div>
                                        <button type="button" className="btn btn-success  rounded">بروزرسانی سبد خرید</button>
                                    </div>
                                </form>
                            ...
                            <div className="cart-price-box justify-content-end  col-4 mt-5 ">
                                ...
                                <div className='d-flex justify-content-around pb-3 pt-3'>
                                    ...
                                    <h5 className='font-weight-bold' style={{ color: " rgb(254, 116, 11)" }}>1,580,000 تومان</h5>
                                </div>
                                ...
                                <form className="mt-3">
                                    <div className="form-group row justify-content-center">
                                        ...
                                        <button type="button" className="btn btn-light">اعمال</button>
                                        <button type="button" className="btn btn-success col-8 mt-3 rounded">ادامه جهت تسویه حساب</button>
                                    </div>
                                </form>
                ...
                < div className="text-center mt-5" >
                    <ShoppingCartOutlined style={{ fontSize: "200px", color: "rgb(228, 228, 228)" }} />
                    <h1 className='font-weight-bold mt-3 mb-3'>سبد خرید شما در حال حاضر خالی است.</h1>
                    <h6>قبل از شروع پرداخت، شما باید برخی از محصولات را به سبد خرید خود اضافه کنید.</h6>
                    <h6>تعداد زیادی از محصولات باکیفیت را در صفحه «فروشگاه» ما پیدا خواهید کرد.</h6>
